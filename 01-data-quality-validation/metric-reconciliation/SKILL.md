...
platforms:
  ...
  - linux
  - windows
description: Trace and resolve discrepancies when the same metric shows 
  different values in two or more sources. Use before reporting, after pipeline 
  changes, or when stakeholders question a number.
tags:
  - data-analytics
  - documentation
